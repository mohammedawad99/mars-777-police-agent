...
| **Replay Viewer** (`REPLAY-001`, `REPLAY-002`) | `VERIFIED` | `uv run python -m mars777_police.replay_main --log … --config …`; per-step `Verified OK` / `TAMPERED`, textual board, `docs/reference/REPLAY_VIEWER.md` |
