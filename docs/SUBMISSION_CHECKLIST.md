...
| `src/**` ≤ 150 code lines per file | `VERIFIED` | 0 violations across 236 files |
| `tests/**` ≤ 150 code lines per file | `PENDING` | **13** files exceed it; the guideline applies the rule to tests too |
